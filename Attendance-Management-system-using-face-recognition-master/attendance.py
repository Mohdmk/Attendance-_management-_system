...
def err_screen():
    ...
    sc1.title("Warning!!")
    sc1.configure(background="lightgray")
    sc1.resizable(0, 0)
    tk.Label(
        sc1,
...
titl = tk.Label(window, bg="lightgray", relief=RIDGE, bd=10, font=("arial", 35))
titl.pack(fill=X)
l1 = tk.Label(window, image=logo1, bg="lightgray",)
l1.place(x=470, y=10)
...
def TakeImageUI():
    ...
    titl = tk.Label(ImageUI, bg="lightgray", relief=RIDGE, bd=10, font=("arial", 35))
    titl.pack(fill=X)
    # image and title
    titl = tk.Label(
        ImageUI, text="Register Your Face", bg="black", fg="black", font=("arial", 30),
    )
