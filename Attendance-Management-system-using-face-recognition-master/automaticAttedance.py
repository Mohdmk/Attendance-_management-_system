...
def subjectChoose(text_to_speech):
    ...
    def select_image():
        ...
        # Load the selected image file and display it in the GUI
    ...
    subject.configure(background="lightgray")
    # subject_logo = Image.open("UI_Image/0004.png")
    # subject_logo = subject_logo.resize((50, 47), Image.ANTIALIAS)
    # subject_logo1 = ImageTk.PhotoImage(subject_logo)
    titl = tk.Label(subject, bg="lightgray", relief=RIDGE, bd=10, font=("arial", 30))
    titl.pack(fill=X)
    # l1 = tk.Label(subject, image=subject_logo1, bg="black",)
    # l1.place(x=100, y=10)
    titl = tk.Label(
        subject,
        text="Enter the RIC Name",
        bg="lightgray",
        fg="navy",
        font=("arial", 25),
    )
    ...
    attf = tk.Button(
        subject,
        text="Upload Image",
        command=FillAttendanceWithImage,
        bd=7,
